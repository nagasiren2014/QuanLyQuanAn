...
namespace QuanLyQuanAn
{
    class bientoancuc
    {
        ...
        public static DataTable BangMonAn2;
       ...
       public static  List<Items> mon = new List<Items>();
        ...
        public static int SLBanCNmoi;
        public static string MaCNmoi, TenCNmoi, DiachiCNmoi, QuanCNmoi, SDTCNmoi, MaDMmoi,TenDMmoi;
        public static string MaMAmoi,TenMAmoi, DVTMAmoi, DonGiaMAmoi;
    }
